...
User.create!(full_name: 'John Doe', role: :customer, phone: +12345678901, email: 'john.doe@test.com', password: 'testtest')
...
Ad.create(country: 'RU', region: 'Moscow', city: 'Moscow', address: "Kremlin", offer: :rent_out,
          user_id: User.find_by(full_name: 'ZeroC0ol').id, price: 10_000_000_999, currency: 'RUB', price_period: :week,
